                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" class="form-control" id="" value="{{$paket->nama}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="penginapan" class="form-control" id="" value="{{$paket->penginapan}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Harga</label>
                                    <input type="text" name="harga" class="form-control" id="" value="{{$paket->harga}}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
